...
import { HorizontalScrollbar } from "./scrollbarSchedule/HorizontalScrollbar/HorizontalScrollbar";
import { VerticalScrollbar } from "./scrollbarSchedule/VerticalScrollbar/VerticalScrollbar";

export abstract class AScrollableContainerSchedule extends AContainer {
  ...
  protected setupHorizontalScrollbar() {
    this.innerContainer.setHeight(
      this.innerContainer.getHeight() - ConfigSc.scrollbarSize
    );
    if (this.horizontalScrollbar && this.verticalScrollbar) {
      ...
      this.horizontalScrollbar.setWidthOffset(ConfigSc.scrollbarSize * 2);
      this.addOnClickHandler();
    }
  }
  ...
  protected setupVerticalScrollbar() {
    this.innerContainer.setWidth(
      this.innerContainer.getWidth() - ConfigSc.scrollbarSize
    );
    if (this.horizontalScrollbar && this.verticalScrollbar) {
      this.createScrollOverlap();
      this.addOnClickHandler();
  ...
  protected createScrollOverlap() {
    this.horizontalScrollbar.setWidthOffset(ConfigSc.scrollbarSize * 3);
    this.verticalScrollbar.setHeightOffset(ConfigSc.scrollbarSize * 3);
