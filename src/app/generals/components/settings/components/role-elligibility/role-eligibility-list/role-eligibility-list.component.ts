...
import { EditRolesService } from "../../../../../../users/services/edit-roles.service";

@Component({
  selector: "app-role-eligibility-list",
  templateUrl: "./role-eligibility-list.component.html",
  styleUrls: ["./role-eligibility-list.component.css"],
})
export class RoleEligibilityListComponent implements OnInit {
  @Input() role = '70';
...
getRoles() {
  if(this.role) {
    this.editRolesService.getRoles(this.role).subscribe({
      next: (response) => {
         if (response.status) {
...
// ngOnInit(): void {
//   this.isChild = this.rang > 1 ? true : false;
//   this.eligibilities.forEach(child =>{
//      let newWord;
//      let words = child.eligibility.split(/[!\s_]+/);
//      let correctWord=[];
//      words.forEach(x => {
...
//     return;
//   }
//   if(eligibility.write && eligibility.read) {
//     eligibility.checked = true;
//   }
//   const updateEligibility = this.deepCopy(eligibility);
//   updateEligibility.checked = !updateEligibility.checked;
//   this.roleEligibilityService.permitChange.next({
//     ...updateEligibility,
//     permit: "check",
//   });
//  // this.roleEligibilityService.setPremissions(this.eligibilities);
//  this.checkDisabledRole();

// }
// changeWriteCheckbox(eligibility) {
//   if (!this.userDetails.create_settings_Global) {
//     return;
//   }
//   const updateEligibility = this.deepCopy(eligibility);
//   updateEligibility.write = !updateEligibility.write;
//   this.roleEligibilityService.permitChange.next({
//     ...updateEligibility,
//     permit: "write",
//   });
...
// changeReadCheckbox(eligibility) {
//   if (!this.userDetails.create_settings_Global) {
//     return;
//   }
//   const updateEligibility = this.deepCopy(eligibility);
//   updateEligibility.read = !updateEligibility.read;
//   this.roleEligibilityService.permitChange.next({
//     ...updateEligibility,
//     permit: "read",
//   });
...
// openCloseList(eligibility) {
//   eligibility.open = !eligibility.open;
// }
