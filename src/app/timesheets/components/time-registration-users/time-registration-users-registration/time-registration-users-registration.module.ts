...
import { TimeRegistrationUsersRegistrationComponent } from "./time-registration-users-registration.component";
...
@NgModule({
  declarations: [TimeRegistrationUsersRegistrationComponent],
  exports: [],
  entryComponents: [],
  bootstrap: [],
  imports: [
...
export class TimeRegistrationUsersRegistrationModule {}
